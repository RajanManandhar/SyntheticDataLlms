...
def save_data_to_db(referral_data):
    try:
        ...
        # Extract fields from the referral data
...
def main():
    json_file_path = 'synth_data.json'
   
    try:
        # Load the data from the JSON file
        with open(json_file_path, 'r') as file:
            referral_data = json.load(file)


        # Save the data to the database
        save_data_to_db(referral_data)
